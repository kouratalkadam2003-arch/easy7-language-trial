...
import { Language, Topic, Station } from './types/remix_types';
...
export const CEFR_CURRICULUM: Record<string, Record<string, { stationName: string; topics: Topic[] }>> = {
  'A1': {
    Station1: {
...
export const TEACHER_PERSONAS: Record<string, TeacherPersona> = {
    'ar': {
        name: 'Roshdy',
        voiceName: 'Puck',
        personality: 'Wise, clear, encouraging guide.',
        colors: { head: '#1a1a1a', body: '#000000', limbs: '#000000', blush: '#333333' }, // Black SVG guide
        accessory: 'glasses'
    },
    'en': { 
        name: 'Mr. James', 
