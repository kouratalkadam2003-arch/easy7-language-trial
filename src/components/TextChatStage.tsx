...
import { StoryContentType, TextChatContentType, TextChatMessage, Language, Flashcard } from '../types/remix_types';
...
const TextChatStage: React.FC<TextChatStageProps> = ({
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const aiResponse = await sendTextChatMessage(currentHistory, userMsg.text, language as any, nativeLanguage as any, level);
