...
export interface GameState {
  ...
  activeDialog: { character: 'eli' | 'tom' | 'dirgham'; message: string; title: string; action?: 'knifehit' | 'zombie' | 'lostlanguage' } | null;
  ...
  dismissDialog: () => void;
  triggerStoryDialog: (character: 'eli' | 'tom' | 'dirgham', title: string, message: string, action?: 'knifehit' | 'zombie' | 'lostlanguage') => void;
